...
json DBManager::getUnSyncedDataLtL3500(const uint32_t &numOfRows)
{
    ...
    unsyncedData["serialNumber"] = "YourSerialNumber"; // Replace with actual serial number
    unsyncedData["instrumentType"] = "YourInstrumentType"; // Replace with actual instrument type

    // Add measurements array to the main object
    unsyncedData["measurements"] = measurements;

    json actualData;
    actualData["serialNumber"] = unsyncedData["serialNumber"];
    actualData["instrumentType"] = unsyncedData["instrumentType"];
    actualData["measurements"] = unsyncedData["measurements"];
